...
type FieldRenderer = {
  ...
  classes?: string
  sortable: boolean
  formatValue?: (transaction: Transaction & { project?: Project | null; category?: Category | null }) => React.ReactNode
...
export const standardFieldRenderers: Record<string, FieldRenderer> = {
  ...
  projectCode: {
    ...
    code: "projectCode",
    sortable: true,
    formatValue: (transaction: Transaction & { project?: Project | null }) =>
  ...
  categoryCode: {
    ...
    code: "categoryCode",
    sortable: true,
    formatValue: (transaction: Transaction & { category?: Category | null }) =>
  ...
  paymentMethod: {
    ...
    code: "paymentMethod",
    sortable: true,
    formatValue: (transaction: Transaction) => <span>{transaction.paymentMethod || "-"}</span>,
  },
  gstPercentage: {
    name: "GST %",
    code: "gstPercentage",
    ...
    sortable: true,
    formatValue: (transaction: Transaction) =>
      <span>{transaction.gstPercentage ? `${transaction.gstPercentage}%` : "-"}</span>,
  },
  gstAmount: {
    name: "GST Amount",
    code: "gstAmount",
    ...
    sortable: true,
    formatValue: (transaction: Transaction) => {
      const gstAmount = transaction.gstAmount
      return <span>{gstAmount && transaction.currencyCode ? formatCurrency(gstAmount, transaction.currencyCode) : "-"}</span>
    },
  },
}
