  ...
  return (
    <form action={createAction} className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <FormInput title="GST %" type="number" min="0" max="100" name="gstPercentage" defaultValue={formData.gstPercentage} />

        <FormInput title="GST Amount" type="number" step="0.01" name="gstAmount" defaultValue={formData.gstAmount} />
      </div>
