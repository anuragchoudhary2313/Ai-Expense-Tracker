...
export const DEFAULT_CATEGORIES = [
  {
    ...
    name: "Bills",
    color: "#dc6b2f",
    llm_prompt: "electricity bill, internet bill, utility bills, recharge, subscriptions",
  },
  {
    code: "shopping",
    name: "Shopping",
    color: "#9c4de8",
    llm_prompt: "shopping, marketplace, ecommerce, retail",
  },
  {
    code: "ads",
    name: "Advertisement",
  ...
  { code: "other", name: "Others", color: "#121216", llm_prompt: "other, miscellaneous," },
  { code: "others", name: "Others", color: "#1b1e24", llm_prompt: "other, miscellaneous," },
]
...
export const DEFAULT_FIELDS = [
  ...
  },
  {
    ...
    name: "Payment Method",
    type: "string",
    llm_prompt: "payment method one of UPI, Cash, Card",
    isVisibleInList: true,
    isVisibleInAnalysis: true,
    isRequired: false,
    isExtra: false,
  },
  {
    ...
    name: "GST %",
    type: "number",
    llm_prompt: "GST percentage if available, use 5, 12, 18 or 28",
    isVisibleInList: true,
    isVisibleInAnalysis: true,
    isRequired: false,
    isExtra: false,
  },
  {
    ...
    name: "GST Amount",
    type: "number",
    llm_prompt: "total GST amount in invoice currency",
    isVisibleInList: true,
    isVisibleInAnalysis: true,
    isRequired: false,
    isExtra: false,
      ...
      samples.map((sample, index) =>
        prisma.transaction.create({
          data: {
            ...sample,
            userId,
            issuedAt: new Date(baseDate.getFullYear(), baseDate.getMonth(), Math.max(1, index + 1)),
            files: [],
            items: [],
          },
        })
